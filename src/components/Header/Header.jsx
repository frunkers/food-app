					...
					<div className="header__el header__el_search">
						<form className="header__form">
							<label htmlFor="search" className="header__label">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><circle cx="11.77" cy="11.77" r="8.99" stroke="#AAACAE" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path stroke="#AAACAE" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18.02 18.49 21.54 22"/></svg>
